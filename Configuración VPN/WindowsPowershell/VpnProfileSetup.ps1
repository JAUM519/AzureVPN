				...
				<TLSExtensions
					...
					<FilteringInfo
						...
						<CAHashList Enabled="true">
							<IssuerHash>04 FE C7 E5 D5 1D D5 5B A5 64 2C FF 2B 14 84 C5 8D 51 86 BC </IssuerHash>
...
$Connection = Get-VpnConnection -Name vnet-cuerovilamedina
if($connection -ne $null)
{
	try
    {
     if ($Force -eq $false) {
	    ...
	    Remove-VpnConnection -Name vnet-cuerovilamedina -Force -ErrorAction Stop
...
try
{
    ...
    {
        Add-VpnConnection -Name vnet-cuerovilamedina -ServerAddress azuregateway-73960077-0074-469d-9953-db8818042557-030397751765.vpn.azure.com -TunnelType Ikev2 -AuthenticationMethod Eap -SplitTunneling:$True -RememberCredential -EncryptionLevel Optional -EapConfigXmlStream $EAP -PassThru
    } else {
        Add-VpnConnection -Name vnet-cuerovilamedina -ServerAddress azuregateway-73960077-0074-469d-9953-db8818042557-030397751765.vpn.azure.com -TunnelType Ikev2 -AuthenticationMethod MachineCertificate -SplitTunneling:$True -RememberCredential -EncryptionLevel Optional -PassThru
    }
}
catch
{
...
Add-VpnConnectionRoute -ConnectionName vnet-cuerovilamedina -DestinationPrefix 10.10.0.0/16
Add-VpnConnectionRoute -ConnectionName vnet-cuerovilamedina -DestinationPrefix 172.16.0.0/24
